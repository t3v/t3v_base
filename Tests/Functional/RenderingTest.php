<?php
namespace T3v\T3vBase\Tests\Functional;
 ...
 *
 * @package T3v\T3vBase\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Base</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_base/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
