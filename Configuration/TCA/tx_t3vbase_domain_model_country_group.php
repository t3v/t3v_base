...
return [
    ...
    'columns' => [
        ...
        'name' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.name',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'trim, required'
        ...
        'abstract' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.abstract',
            'config' => [
                'type' => 'text',
                'eval' => 'trim'
            ],
        ...
        'countries' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.countries',
            'config' => [
                'type' => 'select',
    ...
    'ctrl' => [
        'title' => $lll . 'tx_t3vbase_domain_model_country_group',
        'label' => 'name',
        // 'label_alt' => 'abstract',
        // 'label_alt_force' => 1,
        // 'descriptionColumn' => 'description',
        'iconfile' => "${resources}/Public/Icons/TCA/CountryGroup.svg",
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'delete' => 'deleted',
        'cruser_id' => 'cruser_id',
