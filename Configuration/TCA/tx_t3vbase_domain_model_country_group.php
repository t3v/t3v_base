...
return [
    ...
    'columns' => [
        ...
        'name' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.columns.name.label',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'required, trim',
        ...
        'label' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.columns.label.label',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'trim',
        ...
        'type' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.columns.type.label',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
                    [$lll . 'tx_t3vbase_domain_model_country_group.columns.type.config.items.default.label', 'default']
                ],
                'eval' => 'required, trim',
                'default' => 'default'
            ],
        ...
        'handle' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.columns.handle.label',
            'config' => [
                'type' => 'slug',
                'generatorOptions' => [
                    'fields' => ['name'],
        ...
        'countries' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.columns.countries.label',
            'config' => [
                'type' => 'select',
        ...
        'description' => [
            'label' => $lll . 'tx_t3vbase_domain_model_country_group.columns.description.label',
            'config' => [
                'type' => 'text',
                'enableRichtext' => true,
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_t3vbase_domain_model_country_group.pid=###CURRENT_PID### AND tx_t3vbase_domain_model_country_group.sys_language_uid IN (-1,0)',
                'items' => [
                    ['', 0],
                ],
                'default' => 0
    ...
    'ctrl' => [
        'title' => $lll . 'tx_t3vbase_domain_model_country_group.ctrl.title',
        'label' => 'name',
        'label_alt' => 'label',
        // 'label_alt_force' => 1,
        'type' => 'type',
        ...
        // ],
        // 'thumbnail' => 'thumbnail',
        'iconfile' => "$iconsFolder/TCA/CountryGroup.svg",
