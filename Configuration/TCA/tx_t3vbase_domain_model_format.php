...
return [
    ...
    'columns' => [
        ...
        'name' => [
            'label' => $lll . 'tx_t3vbase_domain_model_format.name',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'required, trim',
        ...
        'type' => [
            'label' => $lll . 'tx_t3vbase_domain_model_format.type',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
                    [$lll . 'tx_t3vbase_domain_model_format.type.default', 'default']
                ],
                'eval' => 'required, trim',
                'default' => 'default',
                'behaviour' => [
        ...
        'handle' => [
            'label' => $lll . 'tx_t3vbase_domain_model_format.handle',
            'config' => [
                'type' => 'slug',
                'generatorOptions' => [
                    'fields' => ['name'],
        ...
        'description' => [
            'label' => $lll . 'tx_t3vbase_domain_model_format.description',
            'config' => [
                'type' => 'text',
                'enableRichtext' => true,
                'eval' => 'trim',
    ...
    'ctrl' => [
        'title' => $lll . 'tx_t3vbase_domain_model_format',
        'label' => 'name',
        // 'label_alt' => 'label',
        // 'label_alt_force' => 1,
